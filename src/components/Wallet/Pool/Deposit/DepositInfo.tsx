...
type DepositInfoProps = IProps & ReturnType<typeof mapStateToProps> & ReturnType<typeof mapDispatchToProps>
...
const DepositInfo: React.FC<DepositInfoProps> = ({
  ...
  const disableHandler = () =>
    !!error || (values.stts === 0 && !account.expired) || tokens.STTS < values.stts || tokens.BNB < values.bnb
    ...
    >
      <Col xs={12} width="100%">
        <Row align="center" justify="around">
          <TokenValue title="Number of STTS" precision={1} token="STTS" value={values.stts} />
          <TokenValue title="Number of BNB" precision={8} token="BNB" value={values.bnb} />
        </Row>
      </Col>
      <Col xs={12} width="100%">
        <Row align="center" justify="around">
      ...
      <Col xs={12} width="100%">
        <Row align="center" justify="around" direction="column">
          ...
          <DepositButton onClick={freezeHandler} done={confirmed} loading={loading} disable={disableHandler()} />
        </Row>
      </Col>
      <Col xs={12} width="100%">
        <Row align="center" justify="around">
          <TokenValue value="37" token="Day" precision={0} title="Freeze Duration" />
